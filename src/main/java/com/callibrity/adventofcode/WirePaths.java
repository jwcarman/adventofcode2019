...
public class WirePaths {
    ...
    public static class Path {
        ...
        public Set<Point> intersection(Path other) {
            return Sets.intersection(visited, other.visited);
        }
    }

    private static int executeScenario(String pathDescriptor1, String pathDescriptor2) {
        final Path path1 = new Path(pathDescriptor1);
        final Path path2 = new Path(pathDescriptor2);

        return path1.intersection(path2).stream()
