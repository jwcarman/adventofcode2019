...
import com.callibrity.adventofcode.intcode.io.ListInputSupplier;
import com.callibrity.adventofcode.intcode.io.ListOutputConsumer;
...
public class Day2 {
    ...
    void part1() {
        ...
        interpreter.execute(new ListInputSupplier(), new ListOutputConsumer());
